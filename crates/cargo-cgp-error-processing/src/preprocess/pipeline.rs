...
use crate::preprocess::{resugar_symbol, strip_cgp_prefixes};
...
/// bare CGP names (`Symbol`, `Chars`, …) rather than their fully-qualified forms.
const PREPROCESSORS: &[fn(CgpDiagnostic) -> CgpDiagnostic] = &[strip_cgp_prefixes, resugar_symbol];
