...
internals out of this crate is what keeps it small; do not pull them in.
...
(runs the wrapped `cargo check`), [`driver_path.rs`](src/check/driver_path.rs) (locates the sibling
