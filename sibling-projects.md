...
This repository's own documentation lives in the knowledge base, under its `cargo-cgp/` directory:
the usage reference, the implementation documents, the pending-issue list, and the `[CGP-Exxx]`
error-code catalog all moved there.
